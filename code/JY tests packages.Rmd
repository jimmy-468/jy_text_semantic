...
image_path <- "../grp_peers_files/Test image-1.jpg"
```
...
```
JYcomment: Worked fine. I see a greyscale image of cells on the Viewer pane. Got file output.
...
```
JYcomment: Worked fine. I see a black-and-white image of cells on the Viewer pane. Got file output.
...
```
JYcomment: Worked fine. I see a red image of cells on the Viewer pane. Got file output.
...
```
JYcomment: Worked fine. I see a magenta image of cells on the Viewer pane. Got file output.
...
```
JYcomment: Yay! It worked! Graph looks awesome. It represents XYZ-acceleration as a acceleration-vector length (Euclidean) and a _smoothed_ curve of the Euclidian using sliding window method (Mean)
